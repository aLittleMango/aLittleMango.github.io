...
其中$p_{l\left ( x \right )}\left ( x \right )$是 softmax 损失函数，
$\l : \Omega \rightarrow \left \{ 1,\cdots ,K \right \}$是像素点的标签值，$\omega : \Omega \in \mathbb{R}$是像素点的权值，目的是为了给图像中贴近边界点的像素更高的权值。
