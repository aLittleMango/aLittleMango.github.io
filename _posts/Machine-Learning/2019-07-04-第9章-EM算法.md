...
$$
= \log \left( \sum_{Z} \color{green} P \left( Z \mid Y,\theta^{\left( i \right)} \right) \color{black} \frac{ P \left(Y \mid Z,\theta \right) P \left( Z \mid \theta \right)}{\color{green} P \left( Z \mid Y,\theta^{\left( i \right)} \right)}  \color{black} \right) - \log P \left( Y \mid \theta^{\left( i \right)} \right)
$$
...
$$
\sum _ {Z} P \left( Z \mid Y,\theta^{\left( i \right)} \right) \color{black} \frac{ P \left(Y \mid Z,\theta \right) P \left( Z \mid \theta \right)}{P \left( Z \mid Y,\theta^{\left( i \right)} \right)} = E_{Z} \left( \frac{P \left(Y \mid Z,\theta \right) P \left( Z \mid \theta \right)}{P \left( Z \mid Y,\theta^{\left( i \right)}\right)} \right)
$$
