...
$$
\begin{aligned} \mathcal { L } ( w , b , \alpha ) & = \frac { 1 } { 2 } \sum _ { i , j } ^ { m } y ^ { ( i ) } y ^ { ( j ) } \alpha _ { i } \alpha _ { j } \left( x ^ { ( i ) } \right) ^ { T } x ^ { ( j ) } - \sum _ { i = 1 } ^ { m } \alpha _ { i } \left[ y ^ { ( i ) } \left( \left( \sum _ { j = 1 } ^ { m } \alpha _ { j } y ^ { ( j ) } x ^ { ( j ) } \right) ^ { T } x ^ { ( i ) } + b \right) - 1 \right] \\ & = \frac { 1 } { 2 } \sum _ { i , j } ^ { m } y ^ { ( i ) } y ^ { ( j ) } \alpha _ { i } \alpha _ { j } \left( x ^ { ( i ) } \right) ^ { T } x ^ { ( j ) } - \sum _ { i , j } ^ { m } y ^ { ( i ) } y ^ { ( j ) } \alpha _ { i } \alpha _ { j } \left( x ^ { ( i ) } \right) ^ { T } x ^ { ( j ) } - b \sum _ { i = 1 } ^ { m } \alpha _ { i } y ^ { ( i ) } + \sum _ { i = 1 } ^ { m } \alpha _ { i } \\ & = \sum _ { i = 1 } ^ { m } \alpha _ { i } - \frac { 1 } { 2 } \sum _ { i , j } ^ { m } y ^ { ( i ) } y ^ { ( j ) } \alpha _ { i } \alpha _ { j } \left( x ^ { ( i ) } \right) ^ { T } x ^ { ( j ) } \end{aligned}
$$
