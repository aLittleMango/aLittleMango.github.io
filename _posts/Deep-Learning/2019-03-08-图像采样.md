...
W\left(x\right)=
\begin{cases}
 & \left(a+2\right)\left|x\right|^{3}-\left(a+3\right)\left|x\right |^{2}+1 \text{ \qquad for } \left|x\right|\leqslant1 \\
 & a\left|x\right|^{3}-5a\left|x\right|^{2}+8a\left|x\right|-4a \text{ \qquad for } 1<\left|x\right|<2 \\
